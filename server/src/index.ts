...
AppDataSource.initialize()
  .then(() => {
    (async () => {
      ...
      app.use(cors({ origin: ["http://localhost:5173", "http://localhost:5174", "http://10.100.1.43", "http://10.100.1.43:5173", "http://10.100.1.43:3046", "http://localhost:3046"], credentials: true }))
